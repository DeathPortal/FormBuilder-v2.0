...
var AutoCompleteAttr = (function () {
    ...
    AutoCompleteAttr.prototype.filter = function () {
        if (this.query !== "") {
    ...
    AutoCompleteAttr.prototype.setStyle = function () {
        try {
...
AutoCompleteAttr = __decorate([
    core_1.Component({
        ...
        template: "\n        <div class=\"row\" style=\"width: 10%; min-width:200px; padding: 5px; padding-left: 20px; display: inline-block; position: absolute;\">\n            <div class=\"form-inline\" [ngClass]=\"valid?'form-inline':'has-danger'\">\n              <input (blur)=\"check()\" id=\"\" type=\"text\" class=\"validate filter-input form-control col-4\" style=\"padding: 5px;\" [(ngModel)]=\"query\" (keyup)=\"filter()\">\n              <span style=\"font-size: 20px;\">:</span>\n              <input (blur) = \"setStyle()\" id=\"\" type=\"text\" class=\"validate filter-input form-control col-4\" style=\"padding: 5px;\" [(ngModel)]=\"queryval\">\n            </div>\n            <div class=\"dropdown-menu\" *ngIf=\"filteredList.length > 0\" style=\"display:block;\">\n                <a class=\"item-dropdown\" (click)=\"select(item)\" *ngFor=\"let item of filteredList\">{{item}}</a>\n            </div>\n        </div>\n        ",
...
//# sourceMappingURL=style.autoComplete.js.map