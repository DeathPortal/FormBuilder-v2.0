...
var AlignmentComponent = (function () {
    function AlignmentComponent(winRef, selectedEle) {
        this.winRef = winRef;
        this.selectedEle = selectedEle;
        this.windowSize = winRef.nativeWindow.innerWidth;
    }
    AlignmentComponent.prototype.onResize = function (event) {
        this.windowSize = event.target.innerWidth;
    };
    return AlignmentComponent;
}());
AlignmentComponent = __decorate([
    core_1.Component({
...
//# sourceMappingURL=alignment.component.js.map